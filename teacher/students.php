      ...
      <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
        <div class="mdc-card ">
          ...
          <div class="bd-callout bd-callout-warning pl-3 pr-3 pb-2 pt-2 mt-2">
            <p class="m-0 text-dark">Search students according to your classes.</p>
          </div>
          <form class="mdc-layout-grid__inner validate-form" id="searchStudent">
...
<script src="ajax/student.js"></script>
<script>
  load_department();
