...
$user = query_getData1($conn, "SELECT u.status, u.email, td.* from user u LEFT JOIN teacher_detail td on td.user_id=u.id where u.email='$email' and u.role=" . USER_ROLE['teacher']);
...
<main class="content-wrapper">
    <div class="mdc-layout-grid">
        <span class="d-flex align-items-center mb-4">
            ...
            <h3 class="card-title m-0 pl-2">Teacher Profile - (<?= $user['email'] ?>) </h3>
        </span>

        <?php $active_tab = 'profile';
        include_once('./partials/teacher-page-tab.php'); ?>
                    ...
                    <form id="change-personal-info-form" class="mdc-layout-grid__inner validate-form" method="post">
                        ...
                        <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop">
                            <div class="mdc-text-field validate-input" data-validate="Phone is required">
                                <input class="mdc-text-field__input valid-if-input" value="<?= $user['phone'] ?>" type="text" name="phone">
                        ...
                        <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop">
                            <div class="mdc-text-field validate-input" data-validate="Address is required">
                                <input class="mdc-text-field__input valid-if-input" value="<?= $user['address'] ?>" type="text" name="address">
                ...
                <div class="mdc-card p-0">
                    <div class="mdc-layout-grid__inner mb-4">
                        <div class="mdc-layout-grid__cell mdc-layout-grid__cell--span-6">
                            <h3 class="text-dark card-padding pb-0 mb-2">Schedule</h3>
                        </div>
                        <div class="mdc-layout-grid__cell mdc-layout-grid__cell--span-6">
                    ...
                    <ul class="list-group align-items-center">
                        <li class="list-group-item list-group-item-action d-flex row align-items-center">
                            ...
                            <div class="col-sm-4 p-0 text-right">
                                <button type="button" id="<?= ($user['status'] == '1') ? 'teacher-deactivate' : 'teacher-activate' ?>" class="btn btn-outline-danger"><?= ($user['status'] == '1') ? 'Deactivate' : 'Activate' ?></button>
                            </div>
                        </li>
                        <li class="list-group-item list-group-item-action d-flex row align-items-center">
                            <div class="col-sm-8 p-0">
...
<script src="ajax/teacher-single.js"></script>
<script>
